 ...
 *  [Description} :      <Source file for the AVR ATmega 2560 DIO driver>                               *
 ********************************************************************************************************/

#include "../Inc/DIO.h"

volatile uint8 *DDR_REG[]  = {&DIO_DDRA,  &DIO_DDRB,  &DIO_DDRC,  &DIO_DDRD,  &DIO_DDRE,  &DIO_DDRF,  &DIO_DDRG,  &DIO_DDRH,  &DIO_DDRJ,  &DIO_DDRK,  &DIO_DDRL};
volatile uint8 *PIN_REG[]  = {&DIO_PINA,  &DIO_PINB,  &DIO_PINC,  &DIO_PIND,  &DIO_PINE,  &DIO_PINF,  &DIO_PING,  &DIO_PINH,  &DIO_PINJ,  &DIO_PINK,  &DIO_PINL};
volatile uint8 *PORT_REG[] = {&DIO_PORTA, &DIO_PORTB, &DIO_PORTC, &DIO_PORTD, &DIO_PORTE, &DIO_PORTF, &DIO_PORTG, &DIO_PORTH, &DIO_PORTJ, &DIO_PORTK, &DIO_PORTL};
