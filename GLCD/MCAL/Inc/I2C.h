...
#define TWBR_REG      SFR_MEM8(0xB8)
#define TWSR_REG      SFR_MEM8(0xB9)
#define TWAR_REG      SFR_MEM8(0xBA)
#define TWAMR_REG     SFR_MEM8(0xBD)
#define TWDR_REG      SFR_MEM8(0xBB)
#ifndef TWCR_REG
#define TWCR_REG      SFR_MEM8(0xBC)
#endif
...
#define I2C_BusErrorIllegalSTARTorSTOPCondition            0x00

#define TW_READ_BIT		                                   1
#define TW_WRITE_BIT	                                   0
...
typedef enum
{
	I2C_InterruptDisabled,             /* Disable Interrupt */
	I2C_InterruptEnabled               /* Enable Interrupt */
