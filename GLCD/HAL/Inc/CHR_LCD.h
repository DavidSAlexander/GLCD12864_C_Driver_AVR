...
Std_ReturnType LCD_WriteString(const LCD_t *LCD, const uint8 *str);
Std_ReturnType LCD_WriteStringInPos(const LCD_t *LCD, uint8 Row, uint8 Column, const uint8 *Str);
